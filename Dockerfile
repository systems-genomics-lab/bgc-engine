...
RUN git clone https://github.com/ncbi/ncbi-vdb.git && cd $SETUPDIR/ncbi/ncbi-vdb && ./configure && make && make install
RUN git clone https://github.com/ncbi/ngs.git && cd $SETUPDIR/ncbi/ngs && ./configure && make && make install
...
RUN git clone https://github.com/ncbi/ngs-tools.git && cd $SETUPDIR/ncbi/sra-tools && ./configure && make && make install
RUN git clone https://github.com/ncbi/sra-tools.git && cd $SETUPDIR/ncbi/ngs-tools && ./configure && make && make install
